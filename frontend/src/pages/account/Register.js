            ...
            <Stack spacing={4}>
                ...
                <Box>
                  <FormControl id="lastName" isRequired>
                    ...
                    <Input type="text" 
                        ...
                        onChange={(e) => setRegisterModel({...registerModel, username: e.target.value})}/>
                  </FormControl>
                </Box>
              </HStack>
              ...
              <FormControl id="password" isRequired>
                ...
                <InputGroup>
                  <Input type={showPassword ? 'text' : 'password'} 
                        ...
                        onChange={(e) => setRegisterModel({...registerModel, passwordString: e.target.value})}
                    />
              ...
              <FormControl id="birthdate" isRequired>
                 ...
                 <Input type="datetime-local"
                    ...
                    onChange={(e) => setRegisterModel({...registerModel, birthDay: e.target.value})}
                 ></Input>
              </FormControl>
              <FormControl id="weight" isRequired>
                 ...
                 <Input type="number"
                    ...
                    onChange={(e) => setRegisterModel({...registerModel, weight: e.target.value})}
                 ></Input>
              </FormControl>
